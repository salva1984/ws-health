    ...
    return new Response(
      JSON.stringify({
        vars: {
          ...
          symptom_result: {
            specialty: "GENERAL", urgency: "LOW",
            reasoning: "Tuve un problema analizando tu síntoma. Usaré Medicina General.",
            red_flags: [], specialty_name: "Medicina General", red_flags_text: ""
          },
          specialty_name: "Medicina General",
          symptom_reasoning: "Tuve un problema analizando tu síntoma. Usaré Medicina General.",
          red_flags_text: ""
        }
      }),
      { headers: { "Content-Type": "application/json" } }
